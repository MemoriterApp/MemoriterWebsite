...
import placeholderImage from '../../images/bot/placeholder.jpg';
        ...
        <div className={styles.default_main_container_sub}>
          ...
          >
            ...
            <p className={styles.default_main_text}>
              ...
              artificial intelligence powered by the OpenAI API and GTP-3. Our AI-generated
              responses are delivered directly to you in Discord chat, ensuring you get the best
              answers possible. As a testament to the capabilities of our AI, all the text on this
              site was written by GTP-3. To learn more about our AI-powered services, check out our
              FAQ or join our Discord server.
            </p>
          </AnimationOnScroll>
        </div>
      </article>
