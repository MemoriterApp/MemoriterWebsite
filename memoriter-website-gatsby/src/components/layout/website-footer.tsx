...
import '../../styles/layout/website-footer.scss';
        ...
        <footer className='website-footer'>
            ...
            <section className='website-footer-content'>
                ...
                <nav>
                    ...
                    <a className='website-footer-link' href='https://app.memoriter.de/login'>Sign In</a>
                    <a className='website-footer-link' href='https://app.memoriter.de/signup'>Register</a>
