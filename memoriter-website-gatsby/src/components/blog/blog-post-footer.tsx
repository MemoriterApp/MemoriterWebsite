  ...
  return (
    <section className='blog-post-footer'>
      ...
      <div className='blog-post-footer-share'>
        <p>Share this post</p>
        <a
          className='blog-post-footer-share-circle'
          style={{ left: '0' }}
          href={`https://twitter.com/intent/tweet?url=${window.location}/&text=${title}`}
          target='_blank'
          rel='noreferrer'
        >
          <img className='blog-post-footer-share-icon' src={twitterIcon} alt='twitter-icon' />
        </a>
        <a
          className='blog-post-footer-share-circle'
          style={{ left: '45px' }}
        ...
        >
          <img
            className='blog-post-footer-share-icon'
            style={{ marginTop: '-1px' }}
            src={facebookIcon}
            alt='facebook-icon'
          />
        ...
        <a
          ...
          rel='noreferrer'
        >
          <img className='blog-post-footer-share-icon' src={whatsappIcon} alt='twitter-icon' />
        </a>
        <a
          className='blog-post-footer-share-circle'
          style={{ left: '135px' }}
          ...
          rel='noreferrer'
        >
          <img className='blog-post-footer-share-icon' src={emailIcon} alt='email-icon' />
        </a>
      </div>
      ...
      <Link className='blog-post-footer-all-posts' to='/blog'>
        All posts &#129046;
      </Link>
      {/*&#129044; is a unicode arrow symbol*/}
      <div>
        ...
        {allBlogPosts
          ...
          .map((blogPost: any) => {
            ...
            return (
              <Link
                className='blog-post-footer-linked-blog'
                to={`/blog/${blogPost.frontmatter.link}`}
                key={blogPost.id}
              >
                <p className='blog-post-footer-linked-blog-outside'>{blogPost.frontmatter.topic}</p>
                <p
                  className='blog-post-footer-linked-blog-date blog-post-footer-linked-blog-outside'
                ...
                <div style={{ display: 'flex', gap: '20px' }}>
                  ...
                  <GatsbyImage
                    className='blog-post-footer-linked-blog-image'
                    image={thumb}
