        ...
        <div className={styles.default_main_container_sub}>
          ...
          >
            ...
            <p className={styles.default_main_text}>
              ...
              flashcard-based studying is 150% more effective than passive note-taking. Save time
              and focus on your areas of improvement with our algorithm that detects and targets
              your weak points. Enhance your knowledge retention with flashcards.
            </p>
          </AnimationOnScroll>
        </div>
      </article>
        ...
        <div className={styles.default_main_container_sub}>
          ...
          >
            ...
            <p className={styles.default_main_text}>
              ...
              studying experience. By working together, you'll not only find motivation and support
              to succeed, but you'll also save time because you can start studying earlier.
            </p>
          </AnimationOnScroll>
        </div>
      </article>
        ...
        <div className={styles.default_main_container_sub}>
          ...
          >
            ...
            <p className={styles.default_main_text}>
              ...
              open-source project. Just as free food tastes better, we believe that free software
              can have a greater impact on education. By making our project open-source, anyone can
              contribute to making Memoriter an even better tool for learning. Join us in our
              mission to make education more affordable for all.
            </p>
          </AnimationOnScroll>
        </div>
        <div className={styles.default_main_container_sub_image}>
