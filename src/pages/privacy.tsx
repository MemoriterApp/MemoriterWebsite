      ...
      <section className={styles.legal_main}>
        ...
        <article>
          <p>
            ...
            crucial for the app to work, therefore the collection of personal data is unavoidable,
            but we are interested in informing you about for you to feel save while visiting our
            website and app. In the following, it will be explained how and why we process personal
            and user data.
          </p>
          <p>
            This privacy notice for Memoriter LLC ("Company," "we," "us," or "our"), describes how
          ...
          <ul>
            <li>
              Visit our website at http://www.app.memoriter.de, or any website of ours that links to
              this privacy notice
            </li>
        ...
        <article>
          ...
          <p>
            ...
            we may process personal information depending on how you interact with Memoriter LLC and
          ...
          <p>
            ...
            out our data subject request form available here: http://www.app.memoriter.de, or by
        ...
        <article>
          ...
          <article>
            ...
            <p>
              ...
              on the context of your interactions with us and the Services, the choices you make,
            ...
            <p>
              ...
              with your payment instrument. All payment data is stored by Stripe. You may find their
              privacy notice link(s) here: https://stripe.com/de/privacy.
            </p>
            <p>
              Social Media Login Data. We may provide you with the option to register with us using
              your existing social media account details, like your Facebook, Twitter, or other
              social media account. If you choose to register in this way, we will collect the
              information described in the section called "HOW DO WE HANDLE YOUR SOCIAL LOGINS?"
              below.
            </p>
            <p>
        ...
        <article>
          ...
          <ul>
            <li>
              ...
              lawfulness of the processing before its withdrawal, nor will it affect the other
              things we may do with your personal information.
            </li>
            <li>
            ...
            <li>
              ...
              outweigh your interests and fundamental rights and freedoms. For example, we may
        ...
        <article>
          ...
          <p>
            ...
            your personal information, (ii) to request rectification or erasure; (iii) to restrict
            the processing of your personal information; and (iv) if applicable, to data
          ...
          <p>
            ...
            section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below. You will then be removed from
            the marketing lists. However, we may still communicate with you — for example, to send
          ...
          <p>
            ...
            by advertisers on our Services visit http://www.aboutads.info/choices/. For further
        ...
        <article>
          ...
          <p>
            Memoriter LLC has not disclosed, sold, or shared any personal information to third
            parties for a business or commercial purpose in the preceding twelve (12) months.
            Memoriter LLC will not sell or share personal information in the future belonging to
        ...
        <article>
          ...
          <p>
            ...
            contact@memoriter.de or by post to:
          </p>
          <p>Memoriter LLC</p>
          <p>Rudolf-Breitscheid-straße 160 C</p>
          <p>Potsdam, Brandenburg 14482</p>
          <p>Germany</p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            personal information, please visit: http://www.app.memoriter.de.
          </p>
        </article>
      </section>
    </WebsiteLayout>
