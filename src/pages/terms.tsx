  ...
  return (
    <WebsiteLayout currentPage=''>
      ...
      <article className={styles.legal_main}>
        ...
        <p>
          <strong>Last Updated: July 25th, 2022</strong>
        </p>

        <p>
          The Memoriter website located at www.memoriter.de is a copyrighted work belonging to
          Memoriter LLC. Certain features of the Site may be subject to additional guidelines,
        ...
        <p>
          <strong>No Support or Maintenance.</strong> You agree that Company will have no obligation
        ...
        <p>
          ...
          You bear all risks associated with use of your User Content.  You hereby certify that your
          User Content does not violate our Acceptable Use Policy.  You may not represent or imply
          to others that your User Content is in any way provided, sponsored or endorsed by Company.
          Because you alone are responsible for your User Content, you may expose yourself to
          liability. Company is not obliged to backup any User Content that you post; also, your
        ...
        <p>
          ...
          Content, and to grant sublicenses of the foregoing rights, solely for the purposes of
          including your User Content in the Site.  You hereby irreversibly waive any claims and
        ...
        <p>
          ...
          any software intended to damage or alter a computer system or data; (ii) send through the
          Site unsolicited or unauthorized advertising, promotional materials, junk mail, spam,
          chain letters, pyramid schemes, or any other form of duplicative or unsolicited messages;
          (iii) use the Site to harvest, collect, gather or assemble information or data regarding
          other users without their consent; (iv) interfere with, disrupt, or create an undue burden
          on servers or networks connected to the Site, or violate the regulations, policies or
        ...
        <p>
          ...
          other person. Such action may include removing or modifying your User Content, terminating
        ...
        <p>
          ...
          assign to Company all rights in such Feedback and agree that Company shall have the right
          to use and fully exploit such Feedback and related information in any manner it believes
        ...
        <p>
          ...
          You agree not to settle any matter without the prior written consent of Company.  Company
        ...
        <p>
          ...
          Links & Ads are not under the control of Company, and Company is not responsible for any
          Third-Party Links & Ads.  Company provides access to these Third-Party Links & Ads only as
        ...
        <p>
          <strong>Other Users.</strong> Each Site user is solely responsible for any and all of its
        ...
        <p>
          ...
          indirectly out of, or that relates directly or indirectly to, the Site. If you are a
        ...
        <p>
          <strong>Cookies and Web Beacons.</strong> Like any other website, Memoriter uses
        ...
        <p>
          ...
          our suppliers make not guarantee that the site will meet your requirements, will be
        ...
        <p>
          ...
          will at all times be limited to a maximum of fifty U.S. dollars (u.s. $50). The existence
          of more than one claim will not enlarge this limit.  You agree that our suppliers will
        ...
        <p>
          <strong>Term and Termination.</strong> Subject to this Section, these Terms will remain in
          ...
          the Site in violation of these Terms.  Upon termination of your rights under these Terms,
          your Account and right to access and use the Site will terminate immediately.  You
        ...
        <p>
          ...
          Arbitration Agreement applies to you and the Company, and to any subsidiaries, affiliates,
        ...
        <p>
          <strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party
          ...
          relief.  A Notice to the Company should be sent to: Rudolf-Breitscheid-Straße 160c, 14482,
          Potsdam Germany. After the Notice is received, you and the Company may attempt to resolve
        ...
        <p>
          <strong>Arbitration Rules.</strong> Arbitration shall be initiated through the American
          ...
          settlement offer that the Company made to you prior to the initiation of arbitration, the
          Company will pay you the greater of the award or $2,500.00.  Each party shall bear its own
        ...
        <p>
          <strong>Additional Rules for Non-Appearance Based Arbitration.</strong> If non-appearance
        ...
        <p>
          <strong>Time Limits.</strong> If you or the Company pursues arbitration, the arbitration
        ...
        <p>
          <strong>Authority of Arbitrator.</strong> If arbitration is initiated, the arbitrator will
        ...
        <p>
          <strong>Waiver of Jury Trial.</strong> THE PARTIES HEREBY WAIVE THEIR CONSTITUTIONAL AND
        ...
        <p>
          <strong>Waiver of Class or Consolidated Actions.</strong> All claims and disputes within
          the scope of this arbitration agreement must be arbitrated or litigated on an individual
          basis and not on a class basis, and claims of more than one customer or user cannot be
          arbitrated or litigated jointly or consolidated with those of any other customer or user.
        </p>
        ...
        <p>
          <strong>Small Claims Court.</strong> Nonetheless the foregoing, either you or the Company
          may bring an individual action in small claims court.
        </p>

        <p>
          <strong>Emergency Equitable Relief.</strong> Anyhow the foregoing, either party may seek
        ...
        <p>
          <strong>Claims Not Subject to Arbitration.</strong> Notwithstanding the foregoing, claims
        ...
        <p>
          ...
          regulations in other countries. You agree not to export, re-export, or transfer, directly
          or indirectly, any U.S. technical data acquired from Company, or any products utilizing
        ...
        <p>
          ...
          may report complaints to the Complaint Assistance Unit of the Division of Consumer Product
          of the California Department of Consumer Affairs by contacting them in writing at 400 R
          Street, Sacramento, CA 95814, or by telephone at (800) 952-5210.
        </p>

        <p>
          <strong>Electronic Communications.</strong> The communications between you and Company use
        ...
        <p>
          <strong>Entire Terms.</strong> These Terms constitute the entire agreement between you and
          us regarding the use of the Site. Our failure to exercise or enforce any right or
          ...
          relationship to Company is that of an independent contractor, and neither party is an
          ...
          transfer in violation of the foregoing will be null and void.  Company may freely assign
        ...
        <p>
          <strong>Copyright/Trademark Information.</strong> Copyright ©. All rights reserved.  All
          trademarks, logos and service marks displayed on the Site are our property or the property
          of other third-parties. You are not permitted to use these Marks without our prior written
          consent or the consent of such third party which may own the Marks.
        </p>

        <h2>Contact Information</h2>

        <p>Address: Rudolf-Breitscheid-Straße 160c, 14482, Potsdam Germany</p>
        <p>Email: contact@memoriter.de</p>
      </article>
    </WebsiteLayout>
  );
};
